...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BoardWidget::*)(int , int )>(_a, &BoardWidget::cellClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void BoardWidget::cellClicked(int _t1, int _t2)
{
