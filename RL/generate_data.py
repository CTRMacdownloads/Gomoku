...
def ensure_zobrist(N: int):
    """保证 ai_stdin 里的 ZOBRIST 表已经按棋盘大小 N 初始化。"""
    if ai_stdin.ZOBRIST is None or len(ai_stdin.ZOBRIST) != N:
        ai_stdin.ZOBRIST = ai_stdin._zobrist_init(N)
        ai_stdin.TTEntry.clear()
...
if __name__ == "__main__":
    # 你可以根据机器性能自己调这些参数
    generate_dataset(
        num_games=100000,          # 想多一点就改大，比如 200、500
        N=15,
        out_path="gomoku_dataset.pt",
